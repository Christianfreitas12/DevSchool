                        ...
                        <div class="input-new-student"> 
                            <div class="input-left">
                                <div class="agp-input"> 
                                    ...
                                    <div class="input"> <input type="text" valeu={nome} onChange={e => setNome(e.target.value)} /> </div>  
                                </div> 
                                <div class="agp-input">
                                    <div class="number-student"> Chamada: </div>  
                                    <div class="input"> <input type="text" valeu={chamada} onChange={e => setchamada(e.target.value)} /> </div> 
                                </div>
                            </div>
                            ...
                            <div class="input-right">
                                <div class="agp-input">
                                    ...
                                    <div class="input"> <input type="text" valeu={curso} onChange={e => setCurso(e.target.value)} /> </div>  
                                </div>
                                <div class="agp-input">
